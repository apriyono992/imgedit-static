...
export function NotFoundPage() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-950 px-4 text-center">
      <p className="text-[120px] sm:text-[160px] font-black text-gray-900 leading-none select-none mb-2">
        404
      </p>
      <h1 className="text-2xl font-bold text-gray-200 mb-2">Halaman tidak ditemukan</h1>
      ...
      <div className="flex items-center gap-3">
        <button
          onClick={() => navigate(-1)}
          className="inline-flex items-center gap-2 px-5 py-2.5 bg-gray-800 hover:bg-gray-700 text-gray-200 rounded-xl font-medium transition-colors text-sm"
        >
          <ArrowLeft size={15} />
          Kembali
        </button>
